      ...
      <div class="main-sidebar">
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <a href="<?php echo site_url('page') ?>">Ayam Geprek</a>
          </div>
          ...
          <ul class="sidebar-menu">
            ...
            <li><a class="nav-link" href="<?php echo site_url('admin/tambah') ?>"><i class="fas fa-plus-circle"></i> <span>Tambah Menu</span></a></li>
            <li><a class="nav-link" href="<?php echo site_url('admin/menu') ?>"><i class="fas fa-shopping-bag"></i> <span>Data menu</span></a></li>
            <li><a class="nav-link" href="<?php echo site_url('admin/pesanan') ?>"><i class="fas fa-shopping-cart"></i> <span>Pesanan</span></a></li>
